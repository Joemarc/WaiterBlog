...
$class_post_info = ( isset( $class_post_info ) ) ? $class_post_info : '';
...
<div class="post-info<?php echo esc_attr( $class_post_info ); ?>">
	...
	<?php echo alex_zane_the_content(
...
<div class="gallery_list_img">
	<a href="<?php echo esc_url( get_the_permalink() ); ?>">
		<?php $gallery = array_slice($gallery, 0, 10);
		foreach($gallery as $key => $img) { ?>
	    <img src="<?php echo esc_url($img);?>" alt="">
			 <?php
		}
	$class_post_info = !$style_blog ? ' col-md6 col-sm-6 col-xs-12' : '';
	$class_post_info = !empty($gallery) ? ' col-md12 col-sm-12 col-xs-12' : $class_post_info; ?>
	</a>
</div>
<?php } ?>